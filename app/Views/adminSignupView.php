...
<body>
  ...
  <div class="container mb-7 col-8 pt-2 ps-5 bg-light">
  <div class="label h4 text-center p-4 bg-lgreen">Sign Up an Admin </div> <b>
            <hr>
        </b>
    <form name="form" onsubmit="return check()" action="<?= base_url("/SignupController/saveAdminSignup") ?>" class="form-group p-3 mb-5" method="POST">
      <div class="row py-2">
