...
<body>
  ...
  <div class="container mb-6 col-4 pt-2 pb-7 ps-5 bg-light">
  <div class="label h4 text-center p-4 bg-lgreen"> Change Password</div> <b>
            <hr>
        </b>
    
    <form name="form" onsubmit="return check()" action="<?= base_url('/AllUserInfoController/saveChangePassword') ?>" class="form-group p-3" method="POST">
      Old Password <input type="password" class="form-control my-2" name="oldPassword" placeholder="Enter Password" />
      New Password <input type="password" class="form-control my-2" name="newPassword" placeholder="Enter Password" />
      Confirm New Password <input type="password" class="form-control my-2" name="confirmNewPassword" placeholder="Enter Password" />
      <div class="mt-3 col-3 float-right">
        <input type="submit" value="Change" class="form-control sign-btn">
      </div>
    </form>
<?php
  ...
  <script>
    function check() {
      ...
      var confirmNewPassword = document.form.confirmNewPassword.value;
