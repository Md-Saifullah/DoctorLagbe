...
<body>
    ...
    <div class="label h4 text-center p-4 bg-lgreen">Update Informations </div> <b>
            ...
            <form name="form" onsubmit="return check()" action="<?= base_url("/AllUserInfoController/updateAdminInfo/" . $admin[0]['aid']) ?>" class="form-group p-3 mb-5" method="POST">
                <div class="row py-2">

                    <div class="col">
                        Name <input type="text" class="form-control mt-2" name="fname" value="<?= $admin[0]['fname'] ?>" placeholder="First Name" />
                    </div>
                    <div class="col">
                        <label for=""> </label>
                        <input type="text" class="form-control mt-2" name="lname" value="<?= $admin[0]['lname'] ?>" placeholder="Last Name" />
                    </div>

                </div>
                Contact No. <input type="text" class="form-control my-2" name="contact" value="<?= $admin[0]['contact'] ?>" placeholder="Enter Contact No." />
                <!-- Email <input type="email" class="form-control my-2" name="email" placeholder="Enter Email" /> -->
                Address <input type="text" class="form-control my-2" name="address" value="<?= $admin[0]['address'] ?>" placeholder="Enter Address" />
                ...
                <div class="row py-2">
                    ...
                    <div class="col-2">
                        Age <input type="number" class="form-control my-2" name="age" value="<?= $admin[0]['age'] ?>" placeholder="Enter Age" />
                    </div>
                    ...
                    <div class="col-2">
                        ...
                        <div class="col-6">
                            <select name="bloodgroup" id="bloodgroup" class="form-control">
                                <option value="A+" <?php if ($admin[0]['bloodgroup'] == "A+")
                                                        echo "selected";
                                                    ?>>A+</option>
                                <option value="A-" <?php if ($admin[0]['bloodgroup'] == "A+")
                                                        echo "selected";
                                                    ?>>A-</option>
                                <option value="B+" <?php if ($admin[0]['bloodgroup'] == "B+")
                                                        echo "selected";
                                                    ?>>B+</option>
                                <option value="B-" <?php if ($admin[0]['bloodgroup'] == "B-")
                                                        echo "selected";
                                                    ?>>B-</option>
                                <option value="AB+" <?php if ($admin[0]['bloodgroup'] == "AB+")
                                                        echo "selected";
                                                    ?>>AB+</option>
                                <option value="AB-" <?php if ($admin[0]['bloodgroup'] == "AB-")
                                                        echo "selected";
                                                    ?>>AB-</option>
                                <option value="O+" <?php if ($admin[0]['bloodgroup'] == "O+")
                                                        echo "selected";
                                                    ?>>O+</option>
                                <option value="O-" <?php if ($admin[0]['bloodgroup'] == "O-")
                                                        echo "selected";
                    ...
                    <div class="col">
                        ...
                        <div class="row-2">
                            <input type="radio" name="gender" value="Male" class="ms-2" <?php if ($admin[0]['gender'] == "Male") echo "checked"; ?> /> Male
                            <input type="radio" name="gender" value="Female" class="ms-2" <?php if ($admin[0]['gender'] == "Female") echo "checked"; ?> /> Female
                            <input type="radio" name="gender" value="Others" class="ms-2" <?php if ($admin[0]['gender'] == "Others") echo "checked"; ?> /> Others
                        </div>
                    </div>
                </div>
